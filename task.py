...
if __name__ == '__main__':
    ...
    #     for student in course.students_scores:
    #         std = list(filter(lambda x: x.id == student, students_list))
    #         ##print(course.students_scores[student].grades)
    #         grades = course.students_scores[student].grades
    #         attendance = course.students_scores[student].attendance
            
    #         data['students'].append({
    #             'id': student,
    #             'first_name': std[0].name,
    #             'last_name': std[0].surname,
    #             'course': courses.append(course.course_name),
    #             'grades': grades,
    #             'attendance': attendance
    #         })
    # for 

    # json_file = open('Student.json', 'w', encoding='utf-8')
    ...
    # json.dump(data, json_file, default=default, indent=1)
    # print('Data saved')
    # json_file.close()